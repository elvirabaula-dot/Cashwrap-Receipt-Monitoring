...
const AdminDashboard: React.FC<AdminDashboardProps> = ({ 
  ...
  const [activeTab, setActiveTab] = useState<'home' | 'supplier' | 'billing' | 'orders' | 'accounts'>('home');
    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-20">
      ...
      {activeTab === 'home' && (
        <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
          <h3 className="text-xl font-black text-slate-800 uppercase mb-6">Warehouse Inventory</h3>
